...
export function CopyRow({ label, value }: CopyRowProps) {
    ...
    return (
        <div className="grid gap-1.5">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-border/80 bg-white px-4 py-2.5 shadow-sm dark:border-border/60 dark:bg-muted/20 dark:shadow-none">
